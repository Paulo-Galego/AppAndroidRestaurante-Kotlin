package com.galego.restaurante_kotlin.adapter

import android.content.Context
import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.galego.restaurante_kotlin.databinding.FoodItemBinding
import com.galego.restaurante_kotlin.model.Food

class FooodAdapter(private val context: Context, private val foodList: MutableList<Food>):
    RecyclerView.Adapter<FooodAdapter.FoodViewHolder>() {
